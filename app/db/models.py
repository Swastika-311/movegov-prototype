...
class User(Base):
    ...
    origin_city: Mapped[str] = mapped_column(String(120), nullable=True)
    origin_state: Mapped[str] = mapped_column(String(120), nullable=True)
    destination_state: Mapped[str] = mapped_column(String(120), nullable=True)
    move_scope: Mapped[str] = mapped_column(String(20), nullable=True)
